...
private: // Object models, lights, image plane and camera
  ...
  PPMImage earth_texture;
  PPMImage moon_texture;
...
private:
  ...
  RGBValue computeDiffuse(Sphere &object, Point &intersection, Vector &normal,
  ...
  // test to see if point is shadowed
  bool isShadowed(unsigned int sphereIndex, Point &intersection,
